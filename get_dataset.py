...
#     # import pickle
#     # pickle.dump((x_train_list, y_train_list), open("train_set_loaded.p", "wb"))
#     # pickle.dump((x_test_list, y_test_list), open("test_set_loaded.p", "wb"))
#
#     x_train = np.asarray(x_train_list)#tf.convert_to_tensor(np.asarray(x_train_list))
#     y_train = np.asarray(y_train_list)#tf.convert_to_tensor(np.asarray(y_train_list))
#
#     x_test = np.asarray(x_test_list)#tf.convert_to_tensor(np.asarray(x_test_list))
#     y_test = np.asarray(y_test_list)#tf.convert_to_tensor(np.asarray(y_test_list))
